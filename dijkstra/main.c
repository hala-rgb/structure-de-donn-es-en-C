...
int main()
{
    ...
    g = ajouterVilleVoisine("A", "C", 3, g);
    g = ajouterVilleVoisine("A", "D", 4, g);

    g = ajouterVilleVoisine("B", "F", 6, g);
    g = ajouterVilleVoisine("B", "D", 5, g);
    g = ajouterVilleVoisine("B", "C", 4, g);
    g = ajouterVilleVoisine("B", "A", 6, g);

    g = ajouterVilleVoisine("C", "B", 5, g);
    g = ajouterVilleVoisine("C", "D", 1, g);
    g = ajouterVilleVoisine("C", "E", 3, g);
    g = ajouterVilleVoisine("C", "A", 3, g);

    g = ajouterVilleVoisine("D", "B", 5, g);
    g = ajouterVilleVoisine("D", "A", 4, g);
    g = ajouterVilleVoisine("D", "C", 1, g);
    g = ajouterVilleVoisine("D", "F", 3, g);
    g = ajouterVilleVoisine("D", "E", 4, g);

    g = ajouterVilleVoisine("E", "C", 3, g);
    g = ajouterVilleVoisine("E", "D", 4, g);
    g = ajouterVilleVoisine("E", "F", 7, g);

    g = ajouterVilleVoisine("F", "B", 6, g);
    g = ajouterVilleVoisine("F", "D", 3, g);
    g = ajouterVilleVoisine("F", "E", 7, g);
    ...
    printf("\n\n__AFFICHAGE DU PLUS COURT CHEMIN ENTRE A ET F__\n\n");

    ville *plusCourtChemin = obtenirCheminPlusCourt("A", "F", cheminMinimal); //Affiche le chemin le plus court entre A et B
